...
public class Login extends javax.swing.JFrame { 
    String gerente = "admin" ,password = "admin";
    String usuario = "usuario", passw = "usuario";
    String us,pass;
    ...
    public void Entrar(String us, String pass){
        if (gerente.equals(us) && password.equals(pass)) {
            MenuGerente m = new MenuGerente();
            m.setVisible(true);
            this.setVisible(false);
        }
        else if (usuario.equals(us) && passw.equals(pass)) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sistema-de-seguridad.png"))); // NOI18N
